...
# q = """SELECT run FROM files WHERE filename = ?"""
# print(pd.read_sql_query(q, conn, params=['alerts.csv_2024-04-18 16:45:35']))
# cur.execute(query, ["alerts.csv_2024-04-18 16:45:35"])
# conn.commit()
# print(pd.read_sql_query(q, conn, params=['alerts.csv_2024-04-18 16:45:35']))
...
#                         """
# clusters_df = pd.read_sql_query(query, conn, params=["alerts.csv_2024-04-08 23:17:46"])
# print(clusters_df.head(7))
...
#
# db = Database()
# db.switch_current_file("alerts.csv_2024-04-05 16:10:20")
#
# print(db.get_context_by_sequence_id(0))
# print(db.get_filenames())
#
# # db.store_attention(att_df_1)
# # db.store_clusters(clust_df_1)
# # db.fill_cluster_table()

# pao1 = ProcessorAccessObject()
# pao1.run_DeepCASE_dummy()
